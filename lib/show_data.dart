...
class _ShowDataState extends State<ShowData> {
  ...
  apicaling(int index) async {
    ...
    try {
      // Fetch weather data
      final weatherData =
          await getWeather(ProfileList().p_List[index].city, http.Client());
      final temperature = weatherData['days'][0]['temp'].toStringAsFixed(1);
      ...
      Navigator.push(
        ...
        MaterialPageRoute(
          builder: (context) => ShowTemp(
            cityName: ProfileList().p_List[index].city,
